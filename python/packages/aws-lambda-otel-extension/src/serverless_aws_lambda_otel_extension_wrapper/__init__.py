...
#   src/serverless_aws_lambda_otel_extension_wrapper (has __init__.py)
#
...
from serverless.aws_lambda_otel_extension.wrapper.handler import auto_instrumenting_handler  # noqa
