...
EXEC_WRAPPER_START_UNIX_NANO = os.getenv(constants.EXEC_WRAPPER_START_UNIX_NANO_ENV_VAR)

_HANDLER = os.getenv(constants._HANDLER_ENV_VAR)
ORIG_HANDLER = os.getenv(constants.ORIG_HANDLER_ENV_VAR)
