...
- Add support for env SLS_DISABLE_TRACE_SAMPLING

## 0.3.0 (2023-09-14)

### ⚠ BREAKING CHANGES

- Remove `serverless_sdk` alias by upgrading to latest base sdk package

## 0.2.3 (2023-08-10)

### Features

- Add `create_span` method for creating custom spans
...
- Ensure telemetry payloads are gzip compressed
